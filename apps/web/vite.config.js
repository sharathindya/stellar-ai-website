...
import devMockContactPlugin from './plugins/vite-plugin-dev-mock-contact.js';
...
export default defineConfig({
	...
	customLogger: logger,
	plugins: [
		...(isDev ? [inlineEditPlugin(), editModeDevPlugin(), selectionModePlugin(), iframeRouteRestorationPlugin(), sitePagesPlugin(), pocketbaseAuthPlugin(), sessionJournalPlugin(), devMockContactPlugin()] : []),
		react(),
